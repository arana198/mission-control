/**
 * POST /api/reports/strategic-weekly
 * 
 * Generate comprehensive weekly strategic report
 * Analyzes 7-day execution, goal progress, bottlenecks, insights
 * 
 * Response: WeeklyReport (see strategicPlanningEngine.ts)
 */
...
export async function POST(request: Request) {
  try {
    ...
    // Error logged in system: "Report generation failed:", error);
    return new Response(
      JSON.stringify({
        success: false,
...
/**
 * GET /api/reports/strategic-weekly?week=5&year=2026
 * 
 * Fetch stored weekly report
 */
