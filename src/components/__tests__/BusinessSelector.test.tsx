...
describe("BusinessSelector Component", () => {
  ...
  const mockRouter = {
    push: vi.fn(),
    pathname: "/mission-control-hq/overview",
  };
  ...
  describe("Keyboard Navigation", () => {
    ...
    it("should support arrow key navigation", async () => {
      // Act: open dropdown, use arrow keys
  ...
  describe("Business Add/Remove Detection", () => {
    it("should handle new business added", async () => {
      // Act: new business added to database
      // Expected: selector updates with new business

      expect(true).toBe(true); // placeholder
    });

    it("should handle business removed", async () => {
      // Act: business deleted
      // Expected: selector updates, switches to available business if needed

      expect(true).toBe(true); // placeholder
    });

    it("should handle business name/emoji updated", async () => {
      // Act: business edited
      // Expected: selector reflects changes
